...
import { LayerProps, MapLayerMouseEvent, SourceProps, ViewState } from 'react-map-gl';
...
export interface ConnectionProps<T extends Resource = Resource,
  E = any,
...
export interface MapPluginConnection<T extends Resource, E> {
  ...
  /** Override viewport state if necessary */
  makeViewState?: (selectedItem: E) => Partial<ViewState>;

  hashElement?: (e?: E) => string | number | null;
}
...
export interface MapPluginToolbox<T extends Resource, E> {
  ...
  /** Custom viewstate generated by connection based on state of map */
