...
export const affordableHousingSchema: HousingSchema = {
  ...
  hudInspectionScores: {
    ...
    items: [
      { accessor: 'developmentCode', label: '' },
      { accessor: 'state', label: '' },
      { accessor: 'county', label: '' },
      { accessor: 'countyFipsCode', label: '' },
      { accessor: 'hudPropertyName', label: '' },
      { accessor: 'propertyStreetAddress', label: '' },
      { accessor: 'inspectionId', label: '' },
      { accessor: 'inspectionPropertyIdMultiformat', label: '' },
      { accessor: 'inspectionScore', label: '' },
      { accessor: 'inspectionDate', label: '' },
      { accessor: 'participantCode', label: '' },
      { accessor: 'formalParticipantName', label: '' },
    ],
  },
  hudPublicHousingDevelopments: {
